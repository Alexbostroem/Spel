...
WorkspacePath          :=Z:/Spel2/Spel/Spel
ProjectPath            :=Z:/Spel2/Spel
...
$(IntermediateDirectory)/grafik.c$(ObjectSuffix): grafik.c
	...
	$(CC) $(SourceSwitch) "Z:/Spel2/Spel/grafik.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/grafik.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "Z:/Spel2/Spel/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ascii_display.c$(ObjectSuffix): ascii_display.c
	...
	$(CC) $(SourceSwitch) "Z:/Spel2/Spel/ascii_display.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ascii_display.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/graphic_driver.c$(ObjectSuffix): graphic_driver.c
	...
	$(CC) $(SourceSwitch) "Z:/Spel2/Spel/graphic_driver.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/graphic_driver.c$(ObjectSuffix) $(IncludePath)
